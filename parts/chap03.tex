...
各主要开孔的补强计算结果汇总于表 \ref{tab:reinforcement}。计算结果表明：DN600 人孔和 DN100 开孔区域的接管厚壁自补强已足以满足等面积补强准则，无需增设补强圈；DN50 及以下小口径仪表接管因开孔直径小，壳体有效厚度提供的多余金属已覆盖削弱面积，不需另行补强。
...
\begin{table}[!htb]
  ...
  \begin{tabularx}{\textwidth}{@{}c>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X>{\centering\arraybackslash}X@{}}
    ...
    \midrule
    1 & 筒体   & $\phi 610 \times 12$ & 2736 & 4320 & 厚壁接管自补强 \\

...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l l l @{}}
    ...
    排气孔（V1）            & —        & $\phi 80$ mm 圆孔 $\times$ 2，裙座上部对称布置 \\
    排气孔（V2）            & —        & $80 \times 150$ mm 长圆孔 $\times$ 2，与 V1 交错 $90^\circ$ \\
    排液孔（D1）            & —        & $\phi 25$ mm 圆孔 $\times$ 2，裙座底部低位 \\
    检查孔（A1）            & —        & $\phi 500$ mm 圆孔 $\times$ 1，正对 M1 人孔方位 \\
    涂层                    & —        & 外表面防腐涂层 + 防火涂层 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\linewidth}{@{}c c c c c c c c c c@{}}
    ...
    M1  & 人孔        & 筒体侧壁 & 600 & $\phi 610.0 \times 12.0$ & WN & RF & 20 & HG/T 21515 & GB 6479 \\
    \bottomrule
  \end{tabularx}
\end{table}
\end{landscape}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l l l @{}}
    ...
    人孔密封垫片       & 柔性石墨复合垫，DN600 PN20       & HG/T 21514—2014 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}l l l @{}}
    ...
    \midrule
    人孔类型                & 回转盖带颈对焊法兰人孔     & HG/T 21515—2014 \\
    公称直径 DN             & $600$ mm                    & — \\
    公称压力 PN             & $20$（Class 150）           & — \\
    接管规格                & $\phi 610 \times 12$ mm     & — \\
    接管材料                & 20 号钢（GB 6479—2013）   & — \\
    法兰型式                & 带颈对焊法兰（WN）          & HG/T 20592—2009 \\
    法兰密封面              & 突面（RF）                  & — \\
    法兰标准号              & HG/T 20592 WN600-20 RF     & — \\
    法兰外径/厚度           & $\phi 815/36$ mm            & HG/T 20592—2009 \\
    螺栓规格/数量           & M24 $\times$ 140 / 20 个    & HG/T 20613—2009 \\
    垫片（外/内$\times$厚） & $\phi 640/\phi 610 \times 3$ mm & HG/T 20606—2009 \\
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}c c c c c c c c@{}}
    ...
    \midrule
    1  & M1    & 筒体   & $600 \times 12$   & 586   & 2736  & 4320  & 厚壁接管自补强（合格） \\
